    ...
    return (
        <PageWrapper>
            <section className="max-w-md mx-auto px-4 py-20">
                <h2 className="text-4xl text-center mb-10" style={{ fontFamily: "'Playfair Display', serif" }}>Register</h2>
                ...
                <p className="text-center mt-8 text-gray-600">
                    Already have an account? <Link to="/login" className="text-[#D85C63] font-semibold hover:underline">Login</Link>
                </p>
            </section>
        </PageWrapper>
    );
